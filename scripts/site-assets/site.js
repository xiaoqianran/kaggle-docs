/**
 * kaggle Docs chrome — paradigm v3 (aligned to modal-docs)
...
(function () {
  ...
  const STORE_KEY = "kaggle-docs-nav-v3";
  const LANG_KEY = "kaggle-docs-lang";
  ...
  if (active) {
    ...
    if (!anyRestored) {
      const preferred =
        ...
        nav?.querySelector('.track[data-track="cli"]') ||
